...
<body class="register-page">
    <div class="register-container">
        <a href="index.php?page=landing" class="back-to-landing" style="position: absolute; top: 20px; left: 20px;">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>

        <div class="register-header">
            <h1><i class="fas fa-compact-disc"></i> Konzert</h1>
        ...
        <div class="register-body">
            ...
            <form method="POST" action="index.php?action=register">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="confirm_password">Konfirmasi Password <span
